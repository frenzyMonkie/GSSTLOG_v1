                    ...
                    case "beforeShowDay":
                        ...
                        r ||
                            ...
                            (i = function (t) {
                                ...
                                // console.log("fde", e)
                                // console.log(TLctx)
                                e = n.fillDay(t, e) // Формируем td
                                n.setClassActive(e) // Формируем td > a
                                return (e); // ЗДЕСЬ 1
                            });
                        break;
                    case "beforeShow":
        ...
        switch (a) {
            ...
            case "multiple":
                ...
                TLctx.current.timenodes.forEach(item => {
                    ...
                    let contextMatch = item.work_shift == TLctx.current.work_shift && item.work_type == TLctx.current.work_type && TLctx.current.object_id == item.object_id
...
var _datepickerExtension = function (TLctx) {
    ...
    (this.range = !1),
        ...
        (this.fillDayMultiple = function (t, e) {
            var i = e[1],
                ...
                TLctx.current.timenodes.forEach(e => {
                    ...
                    let contextMatch = e.object_id == currentContext.object_id && e.work_shift == currentContext.work_shift && e.work_type == currentContext.work_type
        ...
        (this.setClassActive = function (t) {
            var e = this;
            // console.log("setClassActive t", t)
            setTimeout(function () {
                $("td.selected > a", t.dpDiv).addClass("ui-state-active"), "multiple" == e.range && $("td:not(.selected)", t.dpDiv).removeClass("ui-datepicker-current-day").children().removeClass("ui-state-active");
            });
        });
};
