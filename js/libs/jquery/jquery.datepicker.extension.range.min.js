...
($.datepicker._get_original = $.datepicker._get),
    ($.datepicker._get = function (t, e) {
        ...
        // console.log(e)
        // var useTimeLogContext = s._get( t, "useTimeLogContext" );
        // console.log("s.useTimeLogContext", useTimeLogContext)
        switch (a) {
            case "period":
            case "multiple":
                ...
                switch ((n || ((n = new _datepickerExtension(t.settings.useTimeLogContext)), $(this.dpDiv).data("datepickerExtensionRange", n)), (n.range = a), (n.range_multiple_max = t.settings.range_multiple_max || 0), e)) {
                    case "onSelect":
                        var r = i;
                        r || (r = function () {}),
                            (i = function (t, e) {
    ...
    ($.datepicker._setDate = function (t, e, i) {
        ...
        // console.log("_setDate", useTimeLogContext.current.timenodes)
    ...
    (this.range = !1),
        ...
        (this.fillDayMultiple = function (t, e) {
            ...
            return (
                ...
                a && (i += " selected selected-start selected-end"), // Здесь цепляются теги в случае совпадения дат - только при клике.
                (e[1] = i.trim()),
                e
            );
        }),
