    ...
    (this.range = !1),
        ...
        (this.onSelectMultiple = function (t, e) {
            ...
            useTimeLogContext.current.timenodes.forEach(e => {
                ...
                if (e.date == t) { // Если выделенная ячейка уже совпадает с одной из хранящихся
                    // 1. el.hours != null. Тогда выделяем ячейку и указываем время на отрисовках.
                    // 2. el.hours == null. Тогда снимаем выделение у ячейки и не указываем время на отрисовках.
                    if (e.hours != null) {
                        // el.hours = el.hours
                        useTimeLogContext.current.hours =  e.hours
                        // useTimeLogContext.checkedBtn[1](e.hours)
                    } else {
                        useTimeLogContext.current.hours = null
                        // useTimeLogContext.checkedBtn[1](null)
                        // Такого не может быть, поскольку начальное условие - выделенная ячейка уже совпадает с одной из хранящихся, значи там должно быть указано время.
                        // Но сбросить состояние мы должны, как минимум на всякий случай.
                    }
                }
        ...
        (this.fillDayMultiple = function (t, e) {
            var i = e[1],
                ...
                // })
                // const wait = async () => {
                //     while ( !useTimeLogContext.btnGrid[0] ) {
                //         await delay(2500)
                //         console.log(useTimeLogContext.btnGrid[0])
                //     }
                //     await delay(2500)
                //     // console.log(useTimeLogContext.btnGrid[0])
                //     }
