...
$.extend( Datepicker.prototype, {
	...
	_inlineDatepicker: function( target, inst ) {
        ...
        inst.selectedDay = 0
        // console.log(inst)
        // Всё нахуй, здесь точка входа хотя бы.
        // Но проблема в том, что если дату не устанавливать, то календарь скидывается на начало.
	...
	_updateDatepicker: function( inst ) {
        ...
        // console.log( inst.settings.init, this.dpDiv.data("datepickerExtensionRange"))
	...
	_determineDate: function( inst, date, defaultDate ) {
		var offsetNumeric = function( offset ) {
			...
			offsetString = function( offset ) {
                ...
                // init Здесь создается сегодняшняя дата.
                // console.log(inst)
	...
	_generateHTML: function( inst ) {
		...
		for ( row = 0; row < numMonths[ 0 ]; row++ ) {
			...
			for ( col = 0; col < numMonths[ 1 ]; col++ ) {
                // init здесь тоже тупо берется сегодняшняя дата
				...
				for ( dRow = 0; dRow < numRows; dRow++ ) { // create date picker rows
					...
					for ( dow = 0; dow < 7; dow++ ) { // create date picker days
						...
						tbody += "<td class='" +
							...
							( defaultDate != null && printDate.getTime() === currentDate.getTime() ? " " + this._currentClass : "" ) + // highlight selected day
                        ...
                        // $.datepicker._selectDay( event.target, printDate.getMonth(), printDate.getFullYear(), sel[ 0 ] )
					}
					calender += tbody + "</tr>";
				}
				drawMonth++;
